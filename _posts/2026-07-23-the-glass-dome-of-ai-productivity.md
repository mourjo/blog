...
AI's probabilistic productivity can reliably be grounded by having a [human in the loop](https://hai.stanford.edu/ai-definitions/what-is-human-in-the-loop), which would require making AI work more at the slower speed of human cognition, nullifying much of the productivity that AI was thought to have brought in the first place. If we want to review AI-written code with the same diligence as we did with human-written code, the whole system needs to become slower and the selling points of AI generated code would be severely diminished. Instead, I tend to trust (hope) that AI is right. I find myself using AI to test AI-generated code and even to summarize AI-generated code. The flaw in that way of working is AI becoming the single point of failure.
